...
**14 PRs open.** Day 5 of the 25-day window. 11 providers, smart router v1+v2+v4 (keyword + opt-in LLM classifier + per-user/per-key preference overrides for pin/exclude/$-cap), credit billing, BYOK fee, MCP, observability dashboard, and guardrails all shipped. Remaining: landing page, docs, onboarding wizard, polish.

**% complete:** ~90% of overall 25-day window. 14 feature PRs shipped; 307 tests passing; all 9 workspaces typecheck green.
