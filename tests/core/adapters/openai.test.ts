...
describe('OpenAI Adapter', () => {
  ...
  describe('transformStreamChunk', () => {
    it('parses a valid SSE data line', () => {
      const raw = '{"id":"chatcmpl-123","object":"chat.completion.chunk","created":1234567890,"model":"gpt-4o","choices":[{"index":0,"delta":{"content":"Hello"},"finish_reason":null}]}'
  ...
  describe('extractUsageFromChunks', () => {
    it('extracts usage from the last chunk', () => {
      const chunks = [
        {
          id: 'chatcmpl-123', object: 'chat.completion.chunk' as const, created: 1234567890, model: 'gpt-4o',
